   ...
   if(document.all)e = event;
	...
	if(!ajax_tooltipObj)	/* Tooltip div not created yet ? */
	{
		ajax_tooltipObj = document.createElement('DIV');
                ajax_tooltipObj.style.position = 'relative';
		...
		contentDiv.style.marginBottom = '15px';
                contentDiv.setAttribute('onclick', 'ajax_hideTooltip();');
		
		// Creating button div
		var buttonDiv = document.createElement('DIV');
		buttonDiv.style.cssText = 'position:absolute;left:15%;top:10px;text-align:center;background-color:#FFF;font-size:0.8em;height:15px;z-index:10000000';
...
function ajax_positionTooltip(e,inputObj)
{
   ...
   ajax_tooltipObj.style.left = leftPos;
   ajax_tooltipObj.style.top = topPos;
} 
